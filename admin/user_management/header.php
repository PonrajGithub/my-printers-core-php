...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class=" d-flex justify-content-center " style="background-color:#f8f9fc;"><img src="../img/logo1.png"
                    style="width:auto; height:70px;" alt="Logo"></div>

            <div class="sidebar-brand-text mt-2 bg-gradient-danger"> <a
                    class="sidebar-brand d-flex justify-content-center" href="../dashboard.php">Admin </a></div>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="view_user.php">View User Details</a>
                    </div>
                </div>
            </li>
                ...
                <nav class="navbar navbar-expand navbar-light topbar mb-4 static-top shadow"
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item bg-gradient-danger rounded p-2">
                            <a class="nav-item text-decoration-none text-white" href="#" data-toggle="modal"
